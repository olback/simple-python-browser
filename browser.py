...
window_width = 360                          # Default: 360 (No quotation marks)
window_height = 600                         # Default: 600 (No quotation marks)
...
class SimpleWebView():
    ...
    def __init__(self):
        ...
        #self.container.pack_start(self.nav, expand=False, fill=False, padding=0) # Disabled by deafult to make the experience as mobile-like as possible.
